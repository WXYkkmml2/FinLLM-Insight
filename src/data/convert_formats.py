...
def main():
    """Main function to run the format conversion process"""
    ...
    try:
        ...
        file_type = config.get('file_type', 'html')

        # Process report files
        logger.info(f"Starting conversion of {file_type} files from {input_dir} to {output_dir}")
        results = process_report_files(
            input_dir=input_dir,
